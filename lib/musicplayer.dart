...
import 'package:fluttery_audio/src/_playlist.dart';
...
import 'package:fluttery_audio/src/_visualizer.dart';
...
import 'package:fluttery/src/radial_drag_gesture_detector.dart';
...
class RadialProgressBar extends StatefulWidget {
  ...
  RadialProgressBar({
    this.trackWidth = 3.0,
    this.trackColor = const Color(0xffb74093),
    this.progressWidth = 5.0,
    this.progressColor = const Color(0xffb74093),
    this.progressPercent = 0.0,
    this.thumbSize = 10.0,
    this.thumbColor = const Color(0xffb74093),
